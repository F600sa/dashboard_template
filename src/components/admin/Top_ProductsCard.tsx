...
function TopProductsCard() {
  return (
    <div className="bg-whiteColor h-auto py-5 rounded-lg container w-[1050.67px] shadow-md px-5 sm:w-[450px]">
            ...
            <>
              ...
              {index !== TopProducts.length - 1 && (
                <div className="pt-[1px] container">
                  <hr className="bg-gray-200 border-100 dark:bg-gray-700 w-[1010px] sm:w-[420px]" />
                </div>
              )}
            </>
          );
