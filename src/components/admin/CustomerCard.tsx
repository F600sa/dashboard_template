...
function TopProductsCard() {
  return (
    <div className="bg-whiteColor h-auto py-5  rounded-lg container w-[380.33px] shadow-md px-5 sm:w-[400px]">
            ...
            <>
              <div className="flex justify-between ">
                ...
                <div className="flex flex-col pr-[140px] sm:pr-[200px]">
                  <p className=" sm:text-[15px]">{item.name}</p>
              ...
              {index !== Customers.length - 1 && (
                <div className="pt-[1px] container">
                  <hr className="bg-gray-200 border-100 dark:bg-gray-700 w-[340px] sm:w-[340px]" />
                </div>
              )}
            </>
          );
