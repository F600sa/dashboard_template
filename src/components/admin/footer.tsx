...
function Footer() {
  return (
    <div className=" pt-[30px] pb-3 container">
      <footer className="flex items-center justify-between container bg-white h-[120px] sm:w-[400px] rounded-lg shadow-md sm:flex-col sm:items-start sm:pl-3">
